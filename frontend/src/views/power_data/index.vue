<template>
  <section class="page" data-module="power_data">
    <header class="page-head">
      <div>
        <h2>发电监测管理</h2>
        <p class="page-desc">维护发电记录，围绕记录编号、电站编号、发电量、辐照度做登记、筛选与状态流转。</p>
      </div>
    ...
    <table class="data-table">
      ...
      <tbody>
        ...
        <tr v-if="!rows.length">
          <td :colspan="columns.length + 1" class="empty-state">暂无发电监测数据，可先登记发电记录</td>
        </tr>
      </tbody>
    </table>
...
const stats = [{"label": "日发电量", "value": 0}, {"label": "异常记录数", "value": 0}, {"label": "电站效率", "value": 0}]
