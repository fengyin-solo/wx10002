<template>
  <section class="page" data-module="spare_part">
    ...
    <table class="data-table">
      ...
      <tbody>
        ...
        <tr v-if="!rows.length">
          <td :colspan="columns.length + 1" class="empty-state">暂无备件管理数据，可先登记备品备件</td>
        </tr>
      </tbody>
    </table>
...
const ENDPOINT = '/api/spare_part'
const columns = ["备件编号", "备件名称", "适用设备", "规格型号", "存放位置", "最低储备", "当前数量", "备件状态"]
const actions = ["出库领用", "报缺采购", "到货入库"]
const statuses = ["充足", "低于安全", "缺货", "已订货"]
const stats = [{"label": "备件种类", "value": 0}, {"label": "缺货备件", "value": 0}, {"label": "本月领用", "value": 0}]
